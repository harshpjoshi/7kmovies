...
function YearlyBreakup() {
  ...
  return (
    <div className="flex flex-col py-[20px] pl-[20px] dark:rounded-lg dark:border dark:border-solid dark:border-gray-600/70  dark:drop-shadow-none drop-shadow-[0_0.8px_2px_rgba(211,211,211,0.8)] bg-white dark:bg-dark-card-bg dark:text-white rounded-lg">
